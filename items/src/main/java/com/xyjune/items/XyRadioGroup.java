...
public class XyRadioGroup extends LinearLayout {
    ...
    public XyRadioGroup(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        setOrientation(VERTICAL);
        init();
    }
                    ...
                    if (event.getAction() == MotionEvent.ACTION_UP) {
                        ...
                        if (!((RadioItem) child).isChecked()) {
                            ...
                            if (mOnCheckedChangeListener != null)
                                mOnCheckedChangeListener.onCheckedChanged(XyRadioGroup.this, child.getId());
                        }
                    }
                    return true;
                }
    ...
    public interface OnCheckedChangeListener {
        void onCheckedChanged(XyRadioGroup radioGroup, int checkedId);
    }
    ...
    private class PassThroughHierarchyChangeListener implements ViewGroup.OnHierarchyChangeListener {
        ...
        public void onChildViewAdded(View parent, View child) {
            if (parent == XyRadioGroup.this && child instanceof RadioItem) {
                int id = child.getId();
